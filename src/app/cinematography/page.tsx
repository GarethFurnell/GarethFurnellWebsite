...
export default function CinematographyPage() {
  ...
  return (
    <div className="min-h-screen text-white font-sans selection:bg-zinc-800">
      <header className="w-full max-w-5xl mx-auto px-6 py-12 flex justify-between items-center">
      ...
      <main className="w-full max-w-5xl mx-auto px-6 pb-24 animate-in fade-in slide-in-from-bottom-4 duration-700">
        <div className="mb-12">
